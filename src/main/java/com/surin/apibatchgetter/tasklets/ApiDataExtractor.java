...
public class ApiDataExtractor implements Tasklet {
    ...
    public RepeatStatus execute( StepContribution contribution, ChunkContext chunkContext ) throws Exception{
        ...
        Call<ResponseStructure<Spot>> spotRequest = SpotClient.getApiService().getAreaBasedList("isDW+bDvas2+e7a0cIHtQ6R8MueDRle8LRPpKDvkuGB85OzSc0rkuyWW+r7v9ApXBYzD5SjBdzJmELHSjbq0wg==", 10000, 2, "WIN", "SpringTour", "1", "json");
        try {
